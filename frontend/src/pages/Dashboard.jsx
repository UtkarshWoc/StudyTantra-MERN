...
import { Folder, Layers, Sparkles, UploadCloud, Rocket } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-indigo-50 dark:bg-indigo-900/30 rounded-2xl p-6 flex items-center justify-between border border-indigo-100 dark:border-indigo-800 transition-colors">
        <div>
          <h2 className="text-2xl font-bold text-indigo-900 dark:text-indigo-100 mb-2">Welcome back!</h2>
          <p className="text-indigo-700 dark:text-indigo-300">Ready to continue your learning journey?</p>
        </div>
        <button className="bg-indigo-600 hover:bg-indigo-700 dark:hover:bg-indigo-500 text-white px-5 py-2.5 rounded-xl font-medium flex items-center shadow-sm transition-colors cursor-pointer">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex items-center space-x-4 transition-colors">
          ...
          <div>
            ...
            <div className="flex items-baseline space-x-2">
              ...
              <span className="text-sm font-medium text-emerald-500">~0%</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex items-center space-x-4 transition-colors">
          ...
          <div>
            <p className="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Quizzes Taken</p>
            <div className="flex items-baseline space-x-2">
              <span className="text-3xl font-bold text-gray-900 dark:text-white">0</span>
              <span className="text-sm font-medium text-emerald-500">~0%</span>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <div className="flex items-center justify-between mb-4">
            ...
            <button className="text-indigo-600 dark:text-indigo-400 text-sm font-medium hover:text-indigo-800 dark:hover:text-indigo-300 cursor-pointer">View All</button>
          </div>
